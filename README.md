...
This repository contains my code implementations, projects, and notes from the **AI Engineer Core Track: LLM Engineering, RAG, QLoRA, Agents** course (Created by Ligency & Ed Donner).

The course covers an intensive 8-week curriculum focused on building and deploying production-ready Generative AI applications, mastering Retrieval-Augmented Generation (RAG), Fine-Tuning (QLoRA), and Autonomous AI Agents.
...
* **Techniques:** Retrieval-Augmented Generation (RAG), QLoRA / LoRA Fine-Tuning, Function Calling, Multi-Modal Systems, Multi-Agent Collaboration
